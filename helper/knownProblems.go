...
var DNSResolution = KnownProblem{Disruption: LocalDNS, Logs: "DNS error: non-recoverable failure in name resolution (4) DNS error: EVUTIL_EAI_FAIL", NextSteps: `1) Locate the DNS servers that were used from the SC logs
